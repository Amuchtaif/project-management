...
<!-- Sidebar -->
<aside id="mainSidebar" class="fixed md:static inset-y-0 left-0 w-64 bg-[#313491] text-white flex-shrink-0 flex flex-col z-50 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out shadow-xl">
    <div class="p-6">
        <!-- Logo Section -->
        ...
        <nav class="space-y-1.5">
            <a href="<?= BASEURL; ?>/dashboard" class="group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?= (strpos($data['judul'], 'Dashboard') !== false) ? 'bg-white text-[#313491] shadow-lg shadow-black/10' : 'text-indigo-100 hover:bg-white/10' ?>">
                <div class="flex-shrink-0 w-5 h-5 flex items-center justify-center transition-colors <?= (strpos($data['judul'], 'Dashboard') !== false) ? 'text-[#313491]' : 'text-indigo-300 group-hover:text-white' ?>">
            ...
            <a href="<?= BASEURL; ?>/project" class="group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?= (strpos($data['judul'], 'Proyek') !== false) ? 'bg-white text-[#313491] shadow-lg shadow-black/10' : 'text-indigo-100 hover:bg-white/10' ?>">
                <div class="flex-shrink-0 w-5 h-5 flex items-center justify-center transition-colors <?= (strpos($data['judul'], 'Proyek') !== false) ? 'text-[#313491]' : 'text-indigo-300 group-hover:text-white' ?>">
            ...
            <a href="<?= BASEURL; ?>/task" class="group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?= (strpos($data['judul'], 'Tugas') !== false) ? 'bg-white text-[#313491] shadow-lg shadow-black/10' : 'text-indigo-100 hover:bg-white/10' ?>">
                <div class="flex-shrink-0 w-5 h-5 flex items-center justify-center transition-colors <?= (strpos($data['judul'], 'Tugas') !== false) ? 'text-[#313491]' : 'text-indigo-300 group-hover:text-white' ?>">
            ...
            <a href="<?= BASEURL; ?>/team" class="group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?= (strpos($data['judul'], 'Tim') !== false) ? 'bg-white text-[#313491] shadow-lg shadow-black/10' : 'text-indigo-100 hover:bg-white/10' ?>">
                <div class="flex-shrink-0 w-5 h-5 flex items-center justify-center transition-colors <?= (strpos($data['judul'], 'Tim') !== false) ? 'text-[#313491]' : 'text-indigo-300 group-hover:text-white' ?>">
            ...
            <a href="<?= BASEURL; ?>/activity" class="group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?= (strpos($data['judul'], 'Aktivitas') !== false) ? 'bg-white text-[#313491] shadow-lg shadow-black/10' : 'text-indigo-100 hover:bg-white/10' ?>">
                <div class="flex-shrink-0 w-5 h-5 flex items-center justify-center transition-colors <?= (strpos($data['judul'], 'Aktivitas') !== false) ? 'text-[#313491]' : 'text-indigo-300 group-hover:text-white' ?>">
    ...
    <div class="mt-auto p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <img src="https://ui-avatars.com/api/?name=<?= urlencode($_SESSION['user']['name']); ?>&background=4f46e5&color=fff" class="w-10 h-10 rounded-full object-cover" alt="Avatar">
                <div class="flex flex-col overflow-hidden max-w-[100px]">
                    <p class="text-[13px] font-bold text-white truncate"><?= $_SESSION['user']['name']; ?></p>
                    <p class="text-[11px] font-medium text-indigo-300 capitalize"><?= $_SESSION['user']['role']; ?></p>
                </div>
            </div>
            <a href="<?= BASEURL; ?>/login/logout" class="text-indigo-300 hover:text-red-400 transition">
